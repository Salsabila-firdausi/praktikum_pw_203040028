...
<head>
    ...
    <link href="https://fonts.googleapis.ns" rel="stylesheet">
...
<body style="font-family: Arial, sans-serif;">
    ...
    <form action="" method="post">
        <ul style="list-style: none;">
            ...
            <li>
                <label for="jenis" style="margin-right: 9px;">Jenis Produk</label>
                : <input type="text" name="jenis" id="jenis" require><br><br>
            </li>
            <li>
                <label for="harga" style="margin-right: 7px;">Harga Produk</label>
